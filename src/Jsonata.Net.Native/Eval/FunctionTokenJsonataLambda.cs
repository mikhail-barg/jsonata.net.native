...
namespace Jsonata.Net.Native.Eval
{
    ...
    internal sealed class FunctionTokenJsonataLambda: FunctionToken
    {
        ...
        internal FunctionTokenJsonataLambda(Symbol expr, JToken input, EvaluationEnvironment environment)
        ...
        {
            return new FunctionTokenJsonataLambda(input: this.input, environment: this.environment, arguments: this.arguments, signature: this.signature, body: this.body, thunk: this.thunk);
        }
    }
}
